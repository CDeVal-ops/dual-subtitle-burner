...
# Import the SubMerger class from the separate module
try:
    from sub_merger import SubMerger
except ImportError:
    # Fallback - try with hyphenated name
    import importlib.util
    spec = importlib.util.spec_from_file_location("sub_merger", "sub-merger.py")
    sub_merger_module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(sub_merger_module)
    SubMerger = sub_merger_module.SubMerger
